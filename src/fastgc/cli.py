...
def main(argv=None):
    ...
    parser.add_argument(
        ...
        required=True,
        help=(
            "Input LAS/LAZ file or folder. "
            "For merge workflow, this should be the tiling workspace root containing tile_manifest.json. "
            "For derive-only, this can be the tiling workspace root, Processed_<SENSOR> root, or FAST_GC folder."
        ),
    )
    parser.add_argument(
        "--out_dir",
    ...
    parser.add_argument(
        ...
        help="Workflow: direct run, tile-only, tile-run, tile-run-merge, merge, or derive-only.",
    )
    parser.add_argument(
        "--products",
        nargs="+",
    ...
    parser.add_argument(
        "--cleanup_tiles",
        action="store_true",
        help="Remove only the raw tile folder after successful tile-run-merge or merge. Merged outputs are preserved.",
    )
    parser.add_argument(
        "--overwrite_tiles",
        action="store_true",
